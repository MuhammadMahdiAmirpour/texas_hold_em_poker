...
class FullHouseValidatorTest(unittest.TestCase):
    ...
    def test_validates_that_cards_have_two_of_a_same_rank_and_three_of_another_rank(self):
    ...
    def test_returns_collection_of_two_cards_of_the_same_rank_and_the_cards_of_the_same_rank(self):
        validator = FullHouseValidator(cards = self.cards)
        self.assertEqual(
